    ...
    <div className="flex flex-col min-h-screen">
      <div className="container mx-auto px-4 py-8 flex-grow">
        ...
        <div className="text-lg">
          <p className="mb-4">
            Hadi Voyage is currently in its developmental phase, with our team
            of engineers working tirelessly to enhance your website experience
            and ensure a more comprehensive agent connecting experience. We are
            dedicated to bringing you the latest advancements and news in space
            travel.
          </p>
          <p>
