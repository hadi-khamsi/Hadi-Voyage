        ...
        <div className="bg-purple-50 shadow rounded-lg p-6 border border-purple-200">
          ...
          <div className="space-y-2 text-gray-700">
            ...
            <div className="flex justify-between">
              ...
              <span>
                ${serviceFee.toLocaleString(undefined, { minimumFractionDigits: 2 })}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-purple-600">Insurance</span>
              <span className="text-purple-600">
                {insurance ? `$${insCost.toLocaleString()}` : '—'}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-purple-600">Training</span>
              <span className="text-purple-600">
                {training ? `$${trainCost.toLocaleString()}` : '—'}
              </span>
            </div>
        ...
        <div className="pb-16">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {[
              ...
              <div
                key={title}
                className="bg-white rounded-lg p-4 flex items-center justify-between transform transition hover:-translate-y-1 shadow"
              >
                <div>
                  ...
                  <button
                    ...
                    className="mt-2 bg-purple-600 text-white py-1 px-4 rounded-full text-sm hover:bg-purple-700"
                  >
                    Details
                  </button>
                </div>
